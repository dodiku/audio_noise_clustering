...
plt.figure(1).subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0.4, hspace=0.5)
# plt.subplot(2,2,1)
...
# plt.colorbar()
print ('\n📊  stft pcolormesh plot is ready!\n')
plt.savefig('plots/stft.png', dpi=300)
